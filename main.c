...
void verification_rejouer(int rejouer, int config_garder, int nb_joueur, int nb_allumettes){
    int fin;
    int save_nb_joueur;
    int save_nb_allumettes;
    int save_regle;
...
// ****************************************************************************************************
        ...
        verification_rejouer(rejouer, config_garder, nb_joueur, nb_allumettes);
    }
